  ...
  "<div id=\"bod1\">\n" +
   ...
   "<tr>\n" +
    "<td valign=\"top\" style=\"line-height: 16px;\">\n" +
     ...
     "\"Download\" button to \"Télécharger\" (French for \"download\"), via a text "+
     "file found in your LimeWire application directory.<br>\n" +
     "<br>\n" +
    ...
    private void buildStatus(StringBuffer page, List completed, List midway, List started) {
     ...
     "<ol>\n" +
      "<li>");
        ...
        page.append(
       " are complete and will require only small revisions during the project evolution.</li>\n" +
      "<li>");
        first = true;
    ...
    private void buildProgress(StringBuffer page, Map charsets) {
       ...
       "<tr>\n" +
        "<td colspan=\"3\" valign=\"top\"><hr noshade size=\"1\">" +
         "Languages written with Latin (Western European) characters:" +
        "</td>\n" +
       "</tr>\n" +
       "<tr>\n" +
        "<td valign=\"top\">" +
       ...
       "<tr>\n" +
        "<td colspan=\"3\" valign=\"top\"><hr noshade size=\"1\">" +
         "Languages written with " + code + " characters:"+
        "</td>\n" +
       "</tr>\n");
