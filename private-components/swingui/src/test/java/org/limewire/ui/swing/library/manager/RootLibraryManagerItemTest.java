...
public class RootLibraryManagerItemTest extends SwingTestCase {
    ...
    public void testNullConstructor() throws Exception {
        ...
        assertEquals(Collections.emptyList(), root.getExcludedChildren());
    ...
    public void testSingleRoot() throws Exception {
        ...
        LibraryManagerItem item = new LibraryManagerItemImpl(root, null, f1, false);
        root.addChild(item);
    ...
    public void testMultipleRoots() throws Exception {
        ...
        LibraryManagerItem item2 = new LibraryManagerItemImpl(root, null, f2, false);
        root.addChild(item2);
