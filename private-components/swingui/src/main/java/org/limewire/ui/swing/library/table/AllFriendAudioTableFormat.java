...
public class AllFriendAudioTableFormat<T extends RemoteFileItem> extends RemoteAudioTableFormat<T> {
    ...
    public AllFriendAudioTableFormat() {
        super( new ColumnStateInfo[] {
                new ColumnStateInfo(NAME_INDEX, "ALL_LIBRARY_AUDIO_TITLE", I18n.tr("Name"), 260, true, true),     
                new ColumnStateInfo(ARTIST_INDEX, "ALL_LIBRARY_AUDIO_ARTIST", I18n.tr("Artist"), 120, true, true), 
                new ColumnStateInfo(ALBUM_INDEX, "ALL_LIBRARY_AUDIO_ALBUM", I18n.tr("Album"), 180, true, true), 
                new ColumnStateInfo(LENGTH_INDEX, "ALL_LIBRARY_AUDIO_LENGTH", I18n.tr("Length"), 60, true, true), 
                new ColumnStateInfo(QUALITY_INDEX, "ALL_LIBRARY_AUDIO_QUALITY", I18n.tr("Quality"), 60, true, true), 
                ...
                new ColumnStateInfo(FROM_INDEX, "ALL_LIBRARY_AUDIO_FROM", I18n.tr("From"), 100, true, true)
        });
    }
