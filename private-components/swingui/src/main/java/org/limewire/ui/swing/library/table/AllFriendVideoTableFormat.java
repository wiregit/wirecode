...
public class AllFriendVideoTableFormat <T extends RemoteFileItem> extends RemoteVideoTableFormat<T> {
    ...
    public AllFriendVideoTableFormat() {
        super(new ColumnStateInfo[] {
                new ColumnStateInfo(NAME_INDEX, "ALL_LIBRARY_VIDEO_NAME", I18n.tr("Name"), 260, true, true),     
                new ColumnStateInfo(EXTENSION_INDEX, "ALL_LIBRARY_VIDEO_EXTENSION", I18n.tr("Extension"), 60, true, true), 
                new ColumnStateInfo(LENGTH_INDEX, "ALL_LIBRARY_VIDEO_LENGTH", I18n.tr("Length"), 80, true, true), 
                new ColumnStateInfo(QUALITY_INDEX, "ALL_LIBRARY_VIDEO_QUALITY", I18n.tr("Quality"), 60, true, true), 
                new ColumnStateInfo(SIZE_INDEX, "ALL_LIBRARY_VIDEO_SIZE", I18n.tr("Size"), 60, true, true),
