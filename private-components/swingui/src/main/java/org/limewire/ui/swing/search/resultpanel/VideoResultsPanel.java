...
public class VideoResultsPanel extends JXPanel implements Scrollable {
    
    private final JList resultsList;
    
    public VideoResultsPanel(EventListModel<VisualSearchResult> listModel, EventSelectionModel<VisualSearchResult> selectionModel) {
        ...
        JLabel title = new JLabel("Video from Everyone");
