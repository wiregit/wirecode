...
public class HeaderButtonBackgroundPainter extends AbstractPainter<JXButton> {
    ...
    @Resource private Color innerSideBorder = PainterUtils.TRASPARENT;
    @Resource private Color outterSideBorder = PainterUtils.TRASPARENT;
    ...
    @Resource private Color backgroundGradientMiddle = PainterUtils.TRASPARENT;
