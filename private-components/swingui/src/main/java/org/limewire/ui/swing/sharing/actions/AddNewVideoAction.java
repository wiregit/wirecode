...
@Singleton
public class AddNewVideoAction implements ActionListener {
    ...
    @Inject
    public AddNewVideoAction(ShareListManager sharingManager, FriendNameTable friendNameTable, LibraryManager libraryManager) {
