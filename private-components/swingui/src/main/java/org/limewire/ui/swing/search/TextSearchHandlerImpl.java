...
class TextSearchHandlerImpl implements SearchHandler {
    ...
    private void addConnectionWarnings(final Search search, 
        ...
        searchListenerRef.set(new SearchListener() {
            ...
            @Override public void handleStoreResult(Search search, ReleaseResult releaseResult) {}
            @Override public void handleStoreStyle(Search search, StoreStyle storeStyle) {}
