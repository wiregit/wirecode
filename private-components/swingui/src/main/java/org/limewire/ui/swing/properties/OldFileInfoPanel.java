 ...
 * file being viewed.
 */
public class OldFileInfoPanel extends JPanel {
    ...
    @Inject
    public OldFileInfoPanel(@Assisted FileInfoType type, @Assisted PropertiableFile propertiableFile, 
            ...
            if(propertiableFile instanceof LocalFileItem) {
                ...
                HyperlinkButton locateInLibrary = new HyperlinkButton( 
                    new AbstractAction(I18n.tr("Locate in Library")) {
                        @Override
                        public void actionPerformed(ActionEvent e) {
                            OldFileInfoPanel.this.getRootPane().getParent().setVisible(false);
