...
public class DropDownHeaderButtonBackgroundPainter extends AbstractPainter<JXButton> {
    ...
    @Resource private Color outsideBorder = PainterUtils.TRASPARENT;
    @Resource private Color outsideBorderCurve1 = PainterUtils.TRASPARENT;
    @Resource private Color outsideBorderCurve2 = PainterUtils.TRASPARENT;
    @Resource private Color insideBorder = PainterUtils.TRASPARENT;
