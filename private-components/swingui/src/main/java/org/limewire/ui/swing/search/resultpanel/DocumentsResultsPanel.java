...
public class DocumentsResultsPanel extends JXPanel implements Scrollable {
    
    private final JList resultsList;
    
    public DocumentsResultsPanel(EventListModel<VisualSearchResult> listModel, EventSelectionModel<VisualSearchResult> selectionModel) {
        ...
        JLabel title = new JLabel("Documents from Everyone");
