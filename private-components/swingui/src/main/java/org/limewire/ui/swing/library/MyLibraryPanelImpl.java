...
class MyLibraryPanelImpl extends JPanel implements MyLibraryPanel {
    private final LibraryTable table;
    
    @Inject
    public MyLibraryPanelImpl(final LibrarySharePanel sharePanel){
    ...
    @Override
    public void setCategory(Category category, EventList<LocalFileItem> localFileList) {
        table.setModel(new LibraryTableModel<LocalFileItem>(localFileList));
    }
