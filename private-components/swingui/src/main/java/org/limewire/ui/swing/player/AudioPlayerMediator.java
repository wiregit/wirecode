...
class AudioPlayerMediator implements PlayerMediator {
    ...
    /* (non-Javadoc)
     * @see org.limewire.ui.swing.player.IPlayerMediator#isActivePlaylist(org.limewire.ui.swing.library.navigator.LibraryNavItem)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.limewire.ui.swing.player.IPlayerMediator#setActivePlaylist(org.limewire.ui.swing.library.navigator.LibraryNavItem)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.limewire.ui.swing.player.IPlayerMediator#setPlaylist(ca.odell.glazedlists.EventList)
     */
    @Override
    ...
    public void resume() {
        ...
        if ((status == PlayerState.STOPPED  || status == PlayerState.UNKNOWN) && fileItem != null) {
            ...
            if (selectedItems.size() > 0) {
                ...
                if (PlayerUtils.isPlayableAudioFile(selectedItem.getFile())) {
    ...
    /* (non-Javadoc)
     * @see org.limewire.ui.swing.player.IPlayerMediator#isPlaylistSupported()
     */
    @Override
