...
public class BrowserPanel extends MozillaPanel {
    ...
    public BrowserPanel(boolean attachNewBrowserOnCreation, VisibilityMode toolbarVisMode,
            VisibilityMode statusbarVisMode) {
        super(null, attachNewBrowserOnCreation, toolbarVisMode, statusbarVisMode);
    }

    public BrowserPanel(VisibilityMode toolbarVisMode, VisibilityMode statusbarVisMode) {
