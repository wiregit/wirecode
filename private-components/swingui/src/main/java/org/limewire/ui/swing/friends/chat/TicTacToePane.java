...
public class TicTacToePane { //extends JPanel implements Displayable, Conversation {
...
//    
//    @AssistedInject
//    public TicTacToePane(@Assisted MessageWriter writer, final @Assisted ChatFriend chatFriend, @Assisted String loggedInID,
...
//        System.out.println("here 4 tictactoepane");
//
