 ...
 */
class MockCombinedShareList implements FileList<LocalFileItem> {
     ...
     */
    public MockCombinedShareList(ListEventPublisher listEventPublisher, ReadWriteLock readWriteLock) {
