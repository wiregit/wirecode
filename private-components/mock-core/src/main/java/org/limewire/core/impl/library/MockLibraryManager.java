...
public class MockLibraryManager implements ShareListManager, LibraryManager {
    ...
    private void initializeMockGnutellaData(){
        ...
        MockLocalFileItem item = new MockLocalFileItem("c:\\Usability\\Giant_Guitar.JPG", 12345,12312,534512,3,2, Category.IMAGE);
        ...
        //The Franks - Business Casual.mp3
      item = new MockLocalFileItem("c:\\Usability\\The Franks - Live and Kickin v1.mp3", 1000,12345,23456, 5,1, Category.AUDIO);
      gnutellaList.addFileItem(item);
      allFileList.addFileItem(item);

      item = new MockLocalFileItem("c:\\Usability\\The Franks - Better now than late.mp3", 1000,12345,23456, 5,1, Category.AUDIO);
      gnutellaList.addFileItem(item);
      allFileList.addFileItem(item);

      
      item = new MockLocalFileItem("c:\\Usability\\The Franks - Pursuit of Happiness.mp3.mp3", 1000,12345,23456, 5,1, Category.AUDIO);
      gnutellaList.addFileItem(item);
      allFileList.addFileItem(item);

      item = new MockLocalFileItem("c:\\Usability\\The Franks - Business Casual.mp3", 1000,12345,23456, 5,1, Category.AUDIO);
      gnutellaList.addFileItem(item);
      allFileList.addFileItem(item);
