...
public final class DebugPanel extends JPanel implements Note {
    ...
    /**
     * Calls {@link #note(Object,Level)} with the current level, which defaults
     * to {@link Level#ERROR}.
     * 
    ...
    /**
     * Color codes <code>msg</code> according to <code>level</code> and
    ...
    private DebugPanel(final Debuggable client) {
        ...
        JCheckBox cb = new JCheckBox(new AbstractAction("Debug") {
            public void actionPerformed(final ActionEvent e) {
                DebugPanel.this.client.setDebug(!DebugPanel.this.client
                        .getDebug());
            }
        });
