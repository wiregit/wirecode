...
public final class SearchSettings extends LimeProps {
     ...
     */
    public static final ProbabilisticBooleanSetting DISABLE_OOB_V2 = FACTORY
            .createRemoteProbabilisticBooleanSetting("DISABLE_OOB_V2", 0f,
                    "SearchSettings.DisableOOBV2", 0f, 1f);

    /**
     * Minimum success rate for OOB proxying (percentage).
     */
    public static final IntSetting OOB_SUCCESS_RATE_GREAT = FACTORY.createRemoteIntSetting(
            "OOB_SUCCESS_RATE_GREAT", 80, "SearchSettings.OOBSuccessRateGreat", 0, 100);

    /**
     * Minimum success rate for OOB querying (percentage).
     */
    public static final IntSetting OOB_SUCCESS_RATE_GOOD = FACTORY.createRemoteIntSetting(
            "OOB_SUCCESS_RATE_GOOD", 60, "SearchSettings.OOBSuccessRateGood", 0, 100);
    ...
    public static final IntSetting OOB_SUCCESS_RATE_TERRIBLE = FACTORY.createRemoteIntSetting(
            "OOB_SUCCESS_RATE_TERRIBLE", 40, "SearchSettings.OOBSuccessRateTerrible", 0, 100);
     ...
     */
    public static final IntSetting ALT_LOCS_TO_DISPLAY = FACTORY.createIntSetting(
            "ALT_LOCS_TO_DISPLAY", 1);
    ...
    public static final IntSetting QUERY_KEY_DELAY = FACTORY.createRemoteIntSetting(
            "QUERY_KEY_DELAY", 500, "MessageRouter.QueryKeyDelay", 10, 10000);

    public static final ProbabilisticBooleanSetting SEND_LIME_RESPONSES = FACTORY
            .createRemoteProbabilisticBooleanSetting("SEND_LIME_RESPONSES", 1.0f,
                    "SearchSettings.sendLimeResponses", 0f, 1.0f);
    ...
    public static final ProbabilisticBooleanSetting PUBLISH_LIME_KEYWORDS = FACTORY
            .createRemoteProbabilisticBooleanSetting("PUBLISH_LIME_KEYWORDS", 1.0f,
                    "SearchSettings.publishLimeKeywords", 0f, 1f);
    ...
    public static final StringArraySetting LIME_SEARCH_TERMS = FACTORY
            .createRemoteStringArraySetting("LIME_SEARCH_TERMS", new String[] { "limewire" },
                    "SearchSettings.limeSearchTerms");
    ...
    public static final StringSetting LIME_SIGNED_RESPONSE = FACTORY
            .createRemoteStringSetting(
                    ...
                    "VTWQABLTOIACAY3PNUXGY2LNMVTXE33VOAXGO3TVORSWY3DBFZ2XI2LMFZCGC5DBD4HW4LDZA65LCAQAAFNQABDEMF2GC5AAAJNUE6DQOVZAAAS3IKWPGF7YAYEFJYACAAAHQ4AAAAAUMAOKDBAD2GNL77776777"
                            ...
                            + "AAAAAAAAAAAAAAAAAAAAAAA", "SearchSettings.limeSignedResponse");

    public static final StringArraySetting LIME_QRP_ENTRIES = FACTORY
            .createRemoteStringArraySetting("LIME_QRP_ENTRIES", new String[] { "limewire", "pro",
                    "limewirepro" }, "SearchSettings.limeQRPEntries");
    ...
    public static final BooleanSetting DESIRES_PARTIAL_RESULTS_REMOTE = FACTORY
            .createRemoteBooleanSetting("DESIRES_PARTIAL_RESULTS_REMOTE_BETA", true,
                    "SearchSettings.desiresPartialResultsBeta");
