...
public class UpdateSettings extends LimeProps {  
    ...
    public static final StringSetting AUTO_UPDATE_VERSION = 
        FACTORY.createRemoteStringSetting("AUTO_UPDATE_VERSION", "1.0.0", "LIMEWIRE_UPDATE_VERSION");
    
    /**
     * guid prefix for which updates are available.
     */
    public static final StringSetting AUTO_UPDATE_PREFIX =
        FACTORY.createRemoteStringSetting("AUTO_UPDATE_PREFIX", "", "LIMEWIRE_UPDATE_PREFIX");
    
    /**
     * max retry attempts for auto-update after which limewire will close and force 
     * upload on next launch
     */
    public static final IntSetting AUTO_UPDATE_MAX_ATTEMTPS = 
        FACTORY.createRemoteIntSetting("AUTO_UPDATE_MAX_ATTEMTPS", 5, "AUTO_UPDATE_MAX_ATTEMTPS", 3, 10);
