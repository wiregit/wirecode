...
BTLinkListener {
	...
	/** List of items that need to be shut down when this torrent stops */
	private final List<Shutdownable> shutdownItems = 
		Collections.synchronizedList(new ArrayList<Shutdownable>());
	...
	public ManagedTorrent(BTMetaInfo info, 
		...
		shutdownItems.add(linkManager);
		shutdownItems.add(choker);
	...
	private synchronized void stopImpl() {
		...
		Runnable closer = new Runnable() {
			public void run() {
				for (Shutdownable toShut : shutdownItems)
					toShut.shutdown();
			}
		};
	...
	private void initializeTorrent() {
		...
		shutdownItems.add(_connectionFetcher);
	}
