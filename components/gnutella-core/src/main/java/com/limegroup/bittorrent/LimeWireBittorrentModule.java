...
import org.limewire.libtorrent.TorrentDownloadFolder;
...
public class LimeWireBittorrentModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(File.class).annotatedWith(TorrentDownloadFolder.class).toProvider(SharingSettings.INCOMPLETE_DIRECTORY);
