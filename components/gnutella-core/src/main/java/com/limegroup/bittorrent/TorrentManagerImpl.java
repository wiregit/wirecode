...
public class TorrentManagerImpl implements TorrentManager {
    ...
    /* (non-Javadoc)
     * @see com.limegroup.bittorrent.TorrentManager#initialize(com.limegroup.gnutella.FileManager, org.limewire.net.ConnectionDispatcher, java.util.concurrent.ScheduledExecutorService, com.limegroup.bittorrent.handshaking.IncomingConnectionHandler)
     */
