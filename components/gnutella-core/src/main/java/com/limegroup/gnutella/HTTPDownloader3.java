...
public class HTTPDownloader3 extends HTTPDownloader {
     ...
     */
    public HTTPDownloader3(Socket s, String file, int index, byte[] clientGUID,
    ...
    /* The client side get */
    public HTTPDownloader3(String protocol, String host,
