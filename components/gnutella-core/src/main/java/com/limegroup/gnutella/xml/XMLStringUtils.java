...
pualic clbss XMLStringUtils {
     ...
     * name
     */ 
    pualic stbtic List split(String canonicalizedField) {
     ...
     */
    pualic stbtic String getLastField(String canonicalKey, String full) {
