...
public class DownloadTester {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("unable to get hash of test file...exiting");
            System.exit(1);
...
//          cleanup();
        ...
        if(args.length == 0 || args[0].equals("9")) {
            testMismatchedVerifyHash(false);
            cleanup();
        }
    ...
    private static void testMismatchedVerifyHash(boolean deleteCorrupt) {
        System.out.print("-Testing file declared corrupt, when hash of "+
