 ...
 *
 * There are only two ways to create a HandshakeResponseData.
 *
...
public class HandshakeResponseData {
    ...
    /**
     * Creates a HandshakeResponseData which defaults the status code and 
     * status message to be "200 Ok" and uses no headers in the response.
     */
    public HandshakeResponseData() {
        statusCode = OK;
    ...
    /**
     * Creates a HandshakeResponseData which defaults the status code and 
     * stutus message to be "200 Ok" and uses the desired headers in the 
     * response.
     * @param headers the headers to use in the response. 
     */
    public HandshakeResponseData(Properties headers) {
        statusCode = OK;
        statusMessage = OK_MESSAGE;
    ...
    /**
     * Creates a HandshakeResponseData with the desired code, msg, and headers
     * to respond with.
     * @param code the response code to use.
     * @param message the response message to use.
     * @param headers the headers to use in the response.
     */
    public HandshakeResponseData(int code, String message, Properties headers) { 
