...
public class BasicReceivedMessageStat extends BasicStatistic {
	 ...
	 */
	private static class UDPReceivedMessageStat extends BasicReceivedMessageStat {
		public void incrementStat() {
			super.incrementStat();
	 ...
	 */
	private static class TCPReceivedMessageStat extends BasicReceivedMessageStat {
		public void incrementStat() {
			super.incrementStat();
			ALL_MESSAGES.incrementStat();
