...
public final class Tiger extends MessageDigestSpi implements Cloneable {
     ...
     */
    private long state0, state1, state2;

    /**
     * Private context for incomplete trailing blocks and padding.
     * INVARIANT: trailing must be in 0..63.
     *
     * Implementation notice: this version complies with the Java
     * Security Provider Interface. However, the standard SPI
     * includes methods that render the algorithm slower than
     * expected and use unnecessary resources. This is documented
     * below.
     */
    ...
    public void engineReset() {
        state0 = 0x0123456789abcdefL;
        state1 = 0xfedcba9876543210L;
        state2 = 0xf096a5b4c3b2e187L;
        trailing = 0;
        for (int i = 63; i >= 0; i--)
           trail[i] = (byte)0;  // clear the evidence
    }
    ...
    public void engineUpdate(byte input) {
        trail[trailing++] = input;
        if (trailing == 64) computeBlock(trail, trailing = 0);
    }
    ...
    public void engineUpdate(byte[] input, int offset, int len) {
        ...
        /* try to terminate a accumulated trailing block */
        while (trailing != 0 && len != 0) {
            trail[trailing++] = input[offset++];
            len--;
            if (trailing == 64) computeBlock(trail, trailing = 0);
        }
        /* update with full 64-byte blocks */
        while (len >= 64) {
            computeBlock(input, offset);
            offset += 64;
            len -= 64;
        }
        /* check partial trailing block and store it if needed */
        if (len != 0) {
            /*
             * The effective block update is delayed until next
             * engineUpdate() or engineDigest() call.
             */
            System.arraycopy(trail, 0, input, offset, len);
        }
    }
	...
	if (hashvalue.length - offset < TIGER_LENGTH)
        ...
        int state;
        state = (int)(state0       );
        hashvalue[offset++] = (byte)(state       );
        hashvalue[offset++] = (byte)(state >>>  8);
        hashvalue[offset++] = (byte)(state >>> 16);
        hashvalue[offset++] = (byte)(state >>> 24);
        state = (int)(state0 >>> 32);
        hashvalue[offset++] = (byte)(state       );
        hashvalue[offset++] = (byte)(state >>>  8);
        hashvalue[offset++] = (byte)(state >>> 16);
    ...
    private void computeBlock(byte[] input, int offset) {
         ...
         * values, in little-endian byte order (optimized for 32-bit
         * native architectures and reduced Java byte-code).
         */
        long x0 =  (long)( ((input[offset++] & 0xff)      ) |
                           ((input[offset++] & 0xff) <<  8) |
                  ...
                  ((long)( ((input[offset++] & 0xff)      ) |
                           ((input[offset++] & 0xff) <<  8) |
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) << 32);
        long x1 =  (long)( ((input[offset++] & 0xff)      ) |
                           ((input[offset++] & 0xff) <<  8) |
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) |
                  ((long)( ((input[offset++] & 0xff)      ) |
                           ...
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) << 32);
        long x2 =  (long)( ((input[offset++] & 0xff)      ) |
                           ((input[offset++] & 0xff) <<  8) |
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) |
                  ((long)( ((input[offset++] & 0xff)      ) |
                           ...
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) << 32);
        long x3 =  (long)( ((input[offset++] & 0xff)      ) |
                           ((input[offset++] & 0xff) <<  8) |
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) |
                  ((long)( ((input[offset++] & 0xff)      ) |
                           ...
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) << 32);
        long x4 =  (long)( ((input[offset++] & 0xff)      ) |
                           ((input[offset++] & 0xff) <<  8) |
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) |
                  ((long)( ((input[offset++] & 0xff)      ) |
                           ...
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) << 32);
        long x5 =  (long)( ((input[offset++] & 0xff)      ) |
                           ((input[offset++] & 0xff) <<  8) |
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) |
                  ((long)( ((input[offset++] & 0xff)      ) |
                           ...
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) << 32);
        long x6 =  (long)( ((input[offset++] & 0xff)      ) |
                           ((input[offset++] & 0xff) <<  8) |
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) |
                  ((long)( ((input[offset++] & 0xff)      ) |
                           ...
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) << 32);
        long x7 =  (long)( ((input[offset++] & 0xff)      ) |
                           ((input[offset++] & 0xff) <<  8) |
                           ((input[offset++] & 0xff) << 16) |
                           ((input[offset++] & 0xff) << 24) ) |
                  ((long)( ((input[offset++] & 0xff)      ) |
         ...
         */
        long a = state0, b = state1, c = state2;
        ...
        /* round(a, b, c, x0, 5) */
        c ^= x0; lo = (int)c; hi = (int)(c >>> 32);
        a -= T1[(lo      ) & 0xff] ^ T2[(lo >>> 16) & 0xff] ^
             T3[(hi      ) & 0xff] ^ T4[(hi >>> 16) & 0xff];
        b += T4[(lo >>> 8) & 0xff] ^ T3[(lo >>> 24)       ] ^
             T2[(hi >>> 8) & 0xff] ^ T1[(hi >>> 24)       ];
        b *= 5;
        /* round(b, c, a, x1, 5) */
        a ^= x1; lo = (int)a; hi = (int)(a >>> 32);
        b -= T1[(lo      ) & 0xff] ^ T2[(lo >>> 16) & 0xff] ^
             T3[(hi      ) & 0xff] ^ T4[(hi >>> 16) & 0xff];
        c += T4[(lo >>> 8) & 0xff] ^ T3[(lo >>> 24)       ] ^
             T2[(hi >>> 8) & 0xff] ^ T1[(hi >>> 24)       ];
        c *= 5;
        /* round(c, a, b, x2, 5) */
        b ^= x2; lo = (int)b; hi = (int)(b >>> 32);
        c -= T1[(lo      ) & 0xff] ^ T2[(lo >>> 16) & 0xff] ^
             T3[(hi      ) & 0xff] ^ T4[(hi >>> 16) & 0xff];
        a += T4[(lo >>> 8) & 0xff] ^ T3[(lo >>> 24)       ] ^
             T2[(hi >>> 8) & 0xff] ^ T1[(hi >>> 24)       ];
        a *= 5;
        /* round(a, b, c, x3, 5) */
        c ^= x3; lo = (int)c; hi = (int)(c >>> 32);
        a -= T1[(lo      ) & 0xff] ^ T2[(lo >>> 16) & 0xff] ^
             T3[(hi      ) & 0xff] ^ T4[(hi >>> 16) & 0xff];
        b += T4[(lo >>> 8) & 0xff] ^ T3[(lo >>> 24)       ] ^
             T2[(hi >>> 8) & 0xff] ^ T1[(hi >>> 24)       ];
        ...
        /*
         * Schedule the previous digest in the current working set.
         */
 ...
 * digested Tiger hash value (in hex 64-bit format), but the actual digests
 ...
 *
 * "abc":   (input bytes 0x61,0x62,0x63, padded with 0x01,0x00,...0x00)
 *      0xf258c1e88414ab2aL (0x2a,0xab,0x14,0x84,0xe8,0xc1,0x58,0xf2),
 *      0x527ab541ffc5b8bfL (0xbf,0xb8,0xc5,0xff,0x41,0xb5,0x7a,0x52),
 *      0x935f7b951c132951L (0x51,0x29,0x93,0x13,0x1c,0x95,0x7b,0x5f)
 *
 * "Tiger":
 *      0x9f00f599072300ddL, 0x276abb38c8eb6decL, 0x37790c116f9d2bdfL
 *
 * "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-":
 *      0x87fb2a9083851cf7L, 0x470d2cf810e6df9eL, 0xb586445034a5a386L
 *
 * "ABCDEFGHIJKLMNOPQRSTUVWXYZ=abcdefghijklmnopqrstuvwxyz+0123456789":
 *      0x467db80863ebce48L, 0x8df1cd1261655de9L, 0x57896565975f9197L
 *
 * "Tiger - A Fast New Hash Function, by Ross Anderson and Eli Biham":
 *      0x0c410a042968868aL, 0x1671da5a3fd29a72L, 0x5ec1e457d3cdb303L
 *
 * "Tiger - A Fast New Hash Function, by Ross Anderson and Eli Biham, " +
 * "proceedings of Fast Software Encryption 3, Cambridge.":
 *      0xebf591d5afa655ceL, 0x7f22894ff87f54acL, 0x89c811b6b0da3193L
 *
 * "Tiger - A Fast New Hash Function, by Ross Anderson and Eli Biham, " +
 * "proceedings of Fast Software Encryption 3, Cambridge, 1996.":
 *      0x3d9aeb03d1bd1a63L, 0x57b2774dfd6d5b24L, 0xdd68151d503974fcL
 *
 * "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-" +
 * "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-":
 *      0x00b83eb4e53440c5L, 0x76ac6aaee0a74858L, 0x25fd15e70a59ffe4L
 */
