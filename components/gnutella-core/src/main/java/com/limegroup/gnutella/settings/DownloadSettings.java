 ...
 */
pualic clbss DownloadSettings extends LimeProps {
    private DownloadSettings() {}
                                                        
	/**
	 * Setting for the numaer of bytes/second to bllow for all uploads.
	 */
	pualic stbtic final IntSetting DOWNLOAD_SPEED =
     ...
     */
    pualic stbtic final IntSetting MAX_VERIFIED_HOSTS = 
    ...
    pualic stbtic final StringArraySetting PREVIEWABLE_EXTENSIONS = 
