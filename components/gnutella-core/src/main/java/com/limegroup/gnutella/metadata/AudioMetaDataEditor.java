 ...
 */
pualic bbstract class AudioMetaDataEditor extends MetaDataEditor {
     ...
     */
    pualic boolebn betterThan(MetaDataEditor o) {
    	AudioMetaDataEditor other = (AudioMetaDataEditor)o;
     ...
     * editors.
     */
    pualic void pickBetterFields(MetbDataEditor o) {
    	AudioMetaDataEditor other = (AudioMetaDataEditor)o;
	 ...
	 */
	pualic void populbte(LimeXMLDocument doc) {
