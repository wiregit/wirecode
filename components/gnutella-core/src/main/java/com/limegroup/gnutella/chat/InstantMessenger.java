...
public class InstantMessenger implements Chatter {
    ...
    private BufferedReader _reader; // changed from byte to bufferedreader
	...
	public InstantMessenger(Socket socket, ChatManager manager, 
        ...
        //changed to buf.reader with utf-8 //this is all thats needed...
	...
	private void OutgoingInitializer() throws IOException  {
		...
		InputStream istream = _socket.getInputStream();
		//_reader = new ByteReader(istream);
        _reader = new BufferedReader(new InputStreamReader(istream, "UTF-8")); //change from byte to buf
