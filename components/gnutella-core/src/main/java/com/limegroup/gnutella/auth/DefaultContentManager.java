...
public class DefaultContentManager implements ContentManager {
    ...
    private static final Log LOG = LogFactory.getLog(DefaultContentManager.class);
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.auth.ContentManagerInt#initialize()
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.auth.ContentManagerInt#shutdown()
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.auth.ContentManagerInt#getCacheSize()
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.auth.ContentManagerInt#setContentAuthority(com.limegroup.gnutella.auth.ContentAuthority)
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.auth.ContentManagerInt#isVerified(com.limegroup.gnutella.URN)
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.auth.ContentManagerInt#request(com.limegroup.gnutella.URN, com.limegroup.gnutella.auth.ContentResponseObserver, long)
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.auth.ContentManagerInt#request(com.limegroup.gnutella.URN, long)
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.auth.ContentManagerInt#getResponse(com.limegroup.gnutella.URN)
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.auth.ContentManagerInt#handleContentResponse(com.limegroup.gnutella.messages.vendor.ContentResponse)
     */
