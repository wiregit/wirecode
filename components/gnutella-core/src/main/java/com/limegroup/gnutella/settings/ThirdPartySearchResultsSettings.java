...
public final class ThirdPartySearchResultsSettings extends LimeProps {
    ...
    private static String readTemporary() {
        ...
        sb.append("limewire|name=limewire\turl=http://limewire.com\tsize=--\tartist=dr. seuss0\talbum=limewire in the hat0\tcreation_time=1231230\tvendor=someone0\tgenre=childrens0\tlicense=free\n");
        sb.append("limewire1\tlimewire|name=limewire1 or limewire\turl=http://limewire.com\tsize=1231\tartist=dr. seuss1\talbum=limewire in the hat1\tcreation_time=1231231\tvendor=someone1\tgenre=childrens1\tlicense=free\n");
        ...
        sb.append("limewire4\tlimewire|name=limewire4 or limewire\turl=http://limewire.com\tsize=1234\tartist=dr. seuss4\talbum=limewire in the hat4\tcreation_time=1231234\tvendor=someone4\tgenre=childrens4\tlicense=free\n");
