 ...
 */
public final class LoopbackReplyHandler implements ReplyHandler {
	...
	public LoopbackReplyHandler(Acceptor acceptor,
	...
	//return QUERY_ROUTE_STATE;
	//}
	
	//public void setQueryRouteState(ManagedConnectionQueryInfo mcqi) {
	//}
