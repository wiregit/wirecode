...
public class IncompleteFileDescImpl extends FileDescImpl implements IncompleteFileDesc {
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.library.IncompleteFileDesc#getAvailableRanges()
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.library.IncompleteFileDesc#loadResponseRanges(org.limewire.collection.IntervalSet)
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.library.IncompleteFileDesc#hasUrnsAndPartialData()
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.library.IncompleteFileDesc#isRangeSatisfiable(long, long)
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.library.IncompleteFileDesc#getAvailableSubRange(long, long)
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.library.IncompleteFileDesc#isRangeSatisfiable(org.limewire.collection.Range)
     */
