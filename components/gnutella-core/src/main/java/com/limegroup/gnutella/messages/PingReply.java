...
public class PingReply extends Message implements Serializable, IpPort {
     ...
     */
    public static PingReply create(byte[] guid, byte ttl, Collection gnutHosts, Collection dhtHosts) {
        return create(
            guid,
            ttl,
     ...
     */
    public static PingReply create(byte[] guid, byte ttl,
                                   IpPort returnAddr, Collection gnutHosts, 
                                   Collection dhtHosts) {
    ...
    public static PingReply
        create(byte[] guid, byte ttl,
               int port, byte[] ip, long files, long kbytes,
               boolean isUltrapeer, int dailyUptime, boolean isGuessCapable,
               String locale, int slots, Collection gnutHosts, Collection dhtHosts) {
    ...
    private PingReply(byte[] guid, byte ttl, byte hops, byte[] payload,
        ...
        List packedDHTIPs = Collections.EMPTY_LIST;
     ...
     */
    private static GGEP addPackedHosts(GGEP ggep, Collection gnutHosts, Collection dhtHosts) {
