...
import com.limegroup.bittorrent.ManagedTorrentImpl;
...
public class LimeWireCoreModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(ManagedTorrentFactory.class).toProvider(FactoryProvider.newFactory(ManagedTorrentFactory.class, ManagedTorrentImpl.class));
