...
public class PurchasedStoreDownloaderFactoryImpl implements PurchasedStoreDownloaderFactory {
    ...
    public StoreDownloader createStoreDownloader(RemoteFileDesc rfd, IncompleteFileManager ifm,
        ...
        return new StoreDownloader(rfd, saveDirectory, fileName, overwrite, saveLocationManager
                .get(), downloadManager.get(), fileManager.get(), incompleteFileManager.get(),
                downloadCallback.get(), networkManager, alternateLocationFactory.get(),
                requeryManagerFactory.get(), queryRequestFactory.get(), onDemandUnicaster.get(),
                downloadWorkerFactory.get(), altLocManager.get(), contentManager.get(),
                sourceRankerFactory.get(), urnCache.get(), savedFileManager.get(),
                verifyingFileFactory.get(), diskController.get(), ipFilter.get(),
