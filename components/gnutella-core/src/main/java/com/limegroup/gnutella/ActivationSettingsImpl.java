...
public class ActivationSettingsImpl implements ActivationSettingsController {
    ...
    private static final String ACTIVATION_HOST = "http://activate.limewire.int/lookup";
    private static final String CACHE_KEY = "3A931AF193AC44F66540CFFC57C3978D";
    private static final String SERV_PUB_KEY = 
        "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDGmaLDX44w4H95Dd11OOUBWIb9TAQfsqCz4JcLD1vT" +
        "tiwY5t07FWnheoU2fe07pAODXc+t0Bh4AqdjZqQxVOSiKRcZsVs18tL3SDwnHsdgZ4D5ewvXzcbHloLe" +
        "NB1JmIAKkg/EkO1H8T+7Qy4h1G1urlEblxsGJ5+nK2ftlCL34wIDAQAB";
