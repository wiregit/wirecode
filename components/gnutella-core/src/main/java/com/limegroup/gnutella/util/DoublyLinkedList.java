...
{    
    ...
    public static void main(String args[]) {
        ...
        //One element list
        a=l.addLast("a");
        Assert.that(a.getKey().equals("a"));
        Assert.that(l.removeFirst()==a);
        Assert.that(l.removeFirst()==null);
        ...
        Assert.that(a.getKey().equals("a"));
        b=l.addLast("b");
        Assert.that(b.getKey().equals("b"));
        l.remove(a);
        Assert.that(l.removeFirst()==b);
        Assert.that(l.removeFirst()==null);
        ...
        Assert.that(b.getKey().equals("b"));
        c=l.addLast("c");
        Assert.that(c.getKey().equals("c"));        
        l.remove(a);
        Assert.that(l.removeFirst()==b);
        Assert.that(l.removeFirst()==c);
        Assert.that(l.removeFirst()==null);
