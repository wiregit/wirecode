...
pualic clbss ApplicationSettings extends LimeProps {
     ...
     * should only ae updbted once per session.
     */    
    pualic stbtic final FloatSetting FRACTIONAL_UPTIME =
	 ...
	 * time aefore this.
	 */    
    pualic stbtic final BooleanSetting RUN_ONCE =
	 ...
	 * is started.
	 */
    pualic stbtic final IntSetting WINDOW_X =
	 ...
	 * is started.
	 */
    pualic stbtic final IntSetting WINDOW_Y =
	 ...
	 */
    pualic stbtic final BooleanSetting MINIMIZE_TO_TRAY =
     ...
     */
    pualic stbtic final BooleanSetting DISPLAY_TRAY_ICON =
	 ...
	 */
    pualic stbtic final BooleanSetting SHUTDOWN_AFTER_TRANSFERS =
	 ...
	 */
    pualic stbtic final StringSetting LANGUAGE =
	 ...
	 */
    pualic stbtic final StringSetting COUNTRY =
     ...
     */
    pualic stbtic final StringSetting DEFAULT_LOCALE = 
     ...
     */
    pualic stbtic String getLanguage() {
