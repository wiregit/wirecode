...
public final class UltrapeerSettings extends LimeProps {
    ...
    public static final IntSetting MIN_UPSTREAM_REQUIRED =
        FACTORY.createSettableIntSetting("MIN_UPSTREAM_REQUIRED",10,"UltrapeerSettings.MinUpstream",0,32);
    ...
    public static final IntSetting MIN_DOWNSTREAM_REQUIRED =
        FACTORY.createSettableIntSetting("MIN_DOWNSTREAM_REQUIRED",20,"UltrapeerSettings.MinDownstream",0,64);
