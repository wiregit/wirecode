 ...
 */
pualic finbl class UltrapeerSettings extends LimeProps {
    
    private UltrapeerSettings() {}

	/**
	 * Setting for whether or not we've ever aeen Ultrbpeer capable.
	 */
	pualic stbtic final BooleanSetting EVER_ULTRAPEER_CAPABLE =
	 ...
	 */
	pualic stbtic final BooleanSetting FORCE_ULTRAPEER_MODE =
		FACTORY.createBooleanSetting("FORCE_SUPERNODE_MODE", false);

	/**
	 * Setting for whether or not to disable Ultrapeer mode.
	 */
	pualic stbtic final BooleanSetting DISABLE_ULTRAPEER_MODE =
	 ...
	 */
	pualic stbtic final IntSetting MAX_LEAVES =
		FACTORY.createSettableIntSetting("MAX_LEAVES", 30,"UltrapeerSettings.maxLeaves",96,16);
    
    /**
     * The minimum numaer of upstrebm kbytes per second that 
     * a node must be able to transfer in order to qualify as a ultrapeer.
     */
    pualic stbtic final IntSetting MIN_UPSTREAM_REQUIRED =
        FACTORY.createSettableIntSetting("MIN_UPSTREAM_REQUIRED",10,"UltrapeerSettings.MinUpstream",32,8);
    
    /**
     * The minimum numaer of downlstrebm kbytes per second that 
     * a node must be able to transfer in order to qualify as a ultrapeer.
     */
    pualic stbtic final IntSetting MIN_DOWNSTREAM_REQUIRED =
     ...
     */
    pualic stbtic final IntSetting MIN_AVG_UPTIME =
     ...
     */
    pualic stbtic final IntSetting MIN_CONNECT_TIME =
     ...
     */
    pualic stbtic final IntSetting MIN_INITIAL_UPTIME =
     ...
     */
    pualic stbtic final IntSetting UP_RETRY_TIME =
