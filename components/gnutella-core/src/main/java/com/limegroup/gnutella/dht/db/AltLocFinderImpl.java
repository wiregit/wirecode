...
public class AltLocFinderImpl implements AltLocFinder {
    ...
    @Inject
    public AltLocFinderImpl(DHTManager manager, AlternateLocationFactory alternateLocationFactory, AltLocManager altLocManager, PushEndpointFactory pushEndpointFactory) {
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.dht.db.AltLocFinder#findAltLocs(com.limegroup.gnutella.URN, com.limegroup.gnutella.dht.db.AltLocSearchListener)
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.dht.db.AltLocFinder#findPushAltLocs(com.limegroup.gnutella.GUID, com.limegroup.gnutella.URN, com.limegroup.gnutella.dht.db.AltLocSearchListener)
     */
    ...
    /* (non-Javadoc)
     * @see com.limegroup.gnutella.dht.db.AltLocFinder#getAlternateLocation(com.limegroup.gnutella.GUID, com.limegroup.gnutella.URN)
     */
