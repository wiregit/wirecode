...
public class UploadQueueingTest extends BaseTestCase {
    ...
    public void setUp() throws Exception {
        ...
        upManager.start(ProviderHacks.getHTTPUploadAcceptor(), fm, RouterService.getCallback(), ProviderHacks.getMessageRouter());
...
//        runner.start();       
        ...
        VerifyingFile vf = ProviderHacks.getVerifyingFileFactory().createVerifyingFile(0);
        vf.open(tmp);
        HTTPDownloader downloader = 
			ProviderHacks.getHTTPDownloaderFactory().create(sb, rfd, vf, true);
        tmp.delete();
        return downloader;
    }
