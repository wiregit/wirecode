...
public final class LicenseSharingTest extends ClientSideTestCase {
	...
	private static void doSettings() {
	    ApplicationSettings.CLIENT_ID.setValue("AHFJGITJEIQOAJGN"); // necessary only before merge -- UPNP manager mucks up.
	    SharingSettings.EXTENSIONS_TO_SHARE.setValue("mp3;ogg");
    ...
    public void testQRPExchange() throws Exception {
        assertEquals(4, rs.getNumSharedFiles());
