...
public class ID3WriterTest extends AudioTestBase {
    ...
    public void testID3v1TagsWriting() throws Exception {
        ...
        File f = CommonUtils.getResourceFile(dir + "ID3V1.mp3");
        assertTrue(f.exists());
    ...
    public void testID3v11TagsWriting() throws Exception {
        ...
        File f = CommonUtils.getResourceFile(dir + "ID3V11.mp3");
        assertTrue(f.exists());
        File TEST_FILE = new File("test0012321.mp3");
        TEST_FILE.delete();
        FileUtils.copy(f, TEST_FILE);
    ...
    public void testID3v22TagsWriting() throws Exception {
        ...
        File f = CommonUtils.getResourceFile(dir + "ID3V22.mp3");
        assertTrue(f.exists());
        File TEST_FILE = new File("test0012321.mp3");
        TEST_FILE.delete();
        FileUtils.copy(f, TEST_FILE);
    ...
    public void testID3v23TagsWriting() throws Exception {
        ...
        File f = CommonUtils.getResourceFile(dir + "ID3V23.mp3");
        assertTrue(f.exists());
        File TEST_FILE = new File("test0012321.mp3");
        TEST_FILE.delete();
        FileUtils.copy(f, TEST_FILE);
    ...
    public void testID3v24TagsWriting() throws Exception {
        ...
        File f = CommonUtils.getResourceFile(dir + "ID3V24.mp3");
        assertTrue(f.exists());
        File TEST_FILE = new File("test0012321.mp3");
        TEST_FILE.delete();
        FileUtils.copy(f, TEST_FILE);
