...
public class BootstrapServerManagerTest extends BaseTestCase {
    ...
    /**
     * Test to make sure that we go back to using the GWebCache servers if all
     * of the hosts in the gnutella.net file have been tried and have failed.
     */
    public void testHitsGWebCachesAfterAllHostsFail() throws Exception {
