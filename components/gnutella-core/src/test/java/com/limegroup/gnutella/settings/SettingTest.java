...
public class SettingTest extends com.limegroup.gnutella.util.BaseTestCase {
    ...
    public void testSetting() throws Exception {
        ...
        settings.FILE_SETTING.setValue(new File("/mickey-mouse.com"));
        ...
        //assertEquals("File set", "/mickey-mouse.com", settings.FILE_SETTING.getValue().toString());
        ...
        //assertEquals("File default", "/temp/turkey.txt", settings2.FILE_SETTING.getValue().toString());
        ...
        //assertEquals("File set", "/mickey-mouse.com", settings2.FILE_SETTING.getValue().toString());
