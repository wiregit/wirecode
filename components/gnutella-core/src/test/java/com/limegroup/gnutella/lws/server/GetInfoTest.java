...
public class GetInfoTest extends AbstractCommunicationSupportWithNoLocalServer {
    ...
    public void testGetInfo() {
        ...
        eq(props, LimeWireUtils.getMinorVersionNumber(),
                LWSIntegrationServices.Info.MinorVersionNumber);
        eq(props, LimeWireUtils.isPro(), LWSIntegrationServices.Info.IsPro);
        eq(props, LimeWireUtils.getMajorVersionNumber(),
                LWSIntegrationServices.Info.MajorVersionNumber);
        eq(props, LimeWireUtils.getServiceVersionNumber(),
                LWSIntegrationServices.Info.ServiceVersionNumber);
