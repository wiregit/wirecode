...
public class ReplyNumberVendorMessageTest extends BaseTestCase {
    ...
    public void testVersion3AllowsLargerMessagesFromNetwork() throws BadPacketException {
        ReplyNumberVendorMessage msg = new ReplyNumberVendorMessage(GUID.makeGuid(), (byte)1, (byte)1, 3, new byte[11]);
        
        try {
            msg = new ReplyNumberVendorMessage(GUID.makeGuid(), (byte)1, (byte)1, 2, new byte[11]);
