...
//        fman.getIncompleteFileList().addIncompleteFile(new File("sam"), urns, "b", 0, verifyingFileFactory.createVerifyingFile(0));
//        
...
//        File specialShare = createNewNamedTestFile(10, "shared", LibraryUtils.APPLICATION_SPECIAL_SHARE);
//        MultiListener listener = new MultiListener();
//        fman.addFileEventListener(listener);
//        waitForLoad();
//        specialShare = createNewNamedTestFile(10, "shared2", LibraryUtils.APPLICATION_SPECIAL_SHARE);
...
//        File file = null;
//        assertFalse("null directory should not be a sensitive directory", LibraryUtils.isSensitiveDirectory(file));
//        file = new File("lksfjlsakjfsldfjak.slfkjs");
//        assertFalse("random file should not be a sensitive directory", LibraryUtils.isSensitiveDirectory(file));
//        
//        //  check that the user's home dir is a sensitive directory
//        String userHome = System.getProperty("user.home");
//        assertTrue("user's home directory should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(userHome)));
//        
...
//        assertTrue("Documents and Settings should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Documents and Settings")));
//        assertTrue("My Documents should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "My Documents")));
//        assertTrue("Desktop should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Desktop")));
//        assertTrue("Program Files should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Program Files")));
//        assertTrue("Windows should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Windows")));
//        assertTrue("Windows should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "WINNT")));
//        
//        setOSName("Windows NT");
//        assertTrue(OSUtils.isWindowsNT());
//        assertTrue("Documents and Settings should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Documents and Settings")));
//        assertTrue("My Documents should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "My Documents")));
//        assertFalse("My Documents in c:\\ should NOT be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File("c:\\Documents")));
//        assertTrue("Desktop should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Desktop")));
//        assertTrue("Program Files should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Program Files")));
//        assertTrue("Windows should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Windows")));
//        assertFalse("Windows should not be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "NOTWINNT")));
//                
//        setOSName("Windows Vista");
//        assertTrue(OSUtils.isWindowsVista());
//        assertTrue("Documents and Settings should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Documents and Settings")));
//        assertTrue("My Documents should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(userHome + File.separator + "Documents")));
//        assertFalse("My Documents in c:\\ should NOT be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File("c:\\Documents")));
//        assertTrue("Desktop should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Desktop")));
//        assertTrue("Program Files should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Program Files")));
//        assertTrue("Windows should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Windows")));
...
//        assertTrue("Documents and Settings should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Documents and Settings")));
//        assertTrue("My Documents should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(userHome + File.separator + "My Documents")));
//        assertTrue("Desktop should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(userHome+ File.separator + "Desktop")));
//        assertTrue("Program Files should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Program Files")));
//        assertTrue("Windows should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Windows")));
//        assertTrue("Windows should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "WINNT")));
//        
...
//        assertTrue("Users should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Users")));
//        assertTrue("System should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "System")));
//        assertTrue("System Folder should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "System Folder")));
//        assertTrue("Previous Systems should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Previous Systems")));
//        assertTrue("private should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "private")));
//        assertTrue("Volumes should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Volumes")));
//        assertTrue("Desktop should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Desktop")));
//        assertTrue("Applications should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Applications")));
//        assertTrue("Applications (Mac OS 9) should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Applications (Mac OS 9)")));
//        assertTrue("Network should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "Network")));
//        
//        setOSName("Linux");
//        assertTrue(OSUtils.isLinux());
//        assertTrue("bin should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "bin")));
//        assertTrue("boot should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "boot")));
//        assertTrue("dev should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "dev")));
//        assertTrue("etc should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "etc")));
//        assertTrue("home should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "home")));
//        assertTrue("mnt should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "mnt")));
//        assertTrue("opt should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "opt")));
//        assertTrue("proc should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "proc")));
//        assertTrue("root should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "root")));
//        assertTrue("sbin should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "sbin")));
//        assertTrue("usr should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "usr")));
//        assertTrue("var should be a sensitive directory", LibraryUtils.isSensitiveDirectory(new File(File.separator + "var")));
//        
//        } finally {
