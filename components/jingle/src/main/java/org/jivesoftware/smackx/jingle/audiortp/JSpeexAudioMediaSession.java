...
public class JSpeexAudioMediaSession extends JingleMediaSession implements MediaSessionListener {
     ...
     */
    public JSpeexAudioMediaSession(final TransportCandidate remote,
