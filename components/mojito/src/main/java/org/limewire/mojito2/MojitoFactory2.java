...
public class MojitoFactory2 {
    ...
    public static DHT createDHT(MessageFactory messageFactory) {
        return createDHT(messageFactory, ContextSettings.getVendor(), 
    ...
    public static DHT createDHT(MessageFactory messageFactory,
        ...
        return new Context(NAME, messageFactory, routeTable, database);
    }
}
