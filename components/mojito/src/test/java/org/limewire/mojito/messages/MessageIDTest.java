...
import org.limewire.mojito.message2.DefaultMessageID;
import org.limewire.mojito.message2.MessageID;
import org.limewire.mojito.message2.DefaultMessageID.MessageSecurityToken;
...
public class MessageIDTest extends MojitoTestCase {
    ...
    public void testEmbeddedSecurityToken() throws Exception {
        ...
        DefaultMessageID messageId1 = DefaultMessageID.createWithSocketAddress(addr1, macManager);
