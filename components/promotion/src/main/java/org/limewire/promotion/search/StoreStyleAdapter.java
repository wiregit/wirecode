 ...
 */
class StoreStyleAdapter implements StoreStyle {
     ...
     */
    StoreStyleAdapter(JSONObject jsonObj, StoreConnection storeConnection) throws IOException, JSONException {
    ...
    StoreStyleAdapter(StoreStyle.Type type, Map<String, String> data, StoreConnection storeConnection)  throws IOException {
        this.type = type;
        this.storeConnection = storeConnection;
    ...
    private Icon getIcon(String icon) throws MalformedURLException {
        return (icon != null) ? storeConnection.loadIcon(icon) : null;
    }
