 ...
 *  Gnutella messages.
 */
public abstract class RUDPMessageImpl extends Message implements RUDPMessage {
    ...
    public static RUDPMessageImpl createMessage(
      ...
      throws BadPacketException {
        ...
        switch (opcode) {
    		case OP_SYN:
                return new SynMessageImpl(guid,ttl,hops, payload);
    		case OP_ACK:
                return new AckMessageImpl(guid,ttl,hops, payload);
    		case OP_KEEPALIVE:
                return new KeepAliveMessageImpl(guid,ttl,hops, payload);
    		case OP_DATA:
                return new DataMessageImpl(guid,ttl,hops, payload);
    		case OP_FIN:
                return new FinMessageImpl(guid,ttl,hops, payload);
        } 
      	throw NO_MATCH;
	}
